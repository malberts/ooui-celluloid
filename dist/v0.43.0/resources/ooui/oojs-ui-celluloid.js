 ...
 * @constructor
 */
OO.ui.CelluloidTheme = function OoUiWikimediaUITheme() {
	// Parent constructor
	OO.ui.CelluloidTheme.super.call( this );
};

/* Setup */

OO.inheritClass( OO.ui.CelluloidTheme, OO.ui.Theme );
 ...
 * @inheritdoc
 */
OO.ui.CelluloidTheme.prototype.getElementClasses = function ( element ) {
	// Parent method
	var variant, isFramed, isActive, isToolOrGroup,
		...
		// Parent method
		classes = OO.ui.CelluloidTheme.super.prototype.getElementClasses.call( this, element );
 ...
 * @inheritdoc
 */
OO.ui.CelluloidTheme.prototype.getDialogTransitionDuration = function () {
	return 250;
};

/* Instantiation */

OO.ui.theme = new OO.ui.CelluloidTheme();

}( OO ) );

//# sourceMappingURL=oojs-ui-celluloid.js.map.json